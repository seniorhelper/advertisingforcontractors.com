...
var MOOD_OF = {
  ...
  whyadvertise:'straight', whyoptimize:'straight', aifuture:'shades',
  missing:'shades', notyet:'straight'
};
...
var SLANG = {
  ...
  /* ── how people actually type hello ─────────────────────────────────── */
  wsup:'what is up', whadup:'what is up', whaddup:'what is up',
  whatsgood:'what is up', whatgood:'what is up', wassgood:'what is up',
  waddup:'what is up', sappnin:'what is up', happenin:'what is up',
  ayo:'hi', aye:'hi', ayy:'hi', ayyy:'hi', yoo:'hi', yooo:'hi',
  yurr:'hi', yurp:'hi', gday:'hi', heyo:'hi', hey:'hi', hallo:'hi',
  hiyah:'hi', henlo:'hi', sup3:'hi', holla:'hi', hollar:'hi',
  dog:'friend', dawg:'friend', doggy:'friend', bossman:'friend',
  brotha:'friend', sis:'friend', sista:'friend', cap:'friend',
  guy:'friend', playa:'friend', champ:'friend', ace:'friend',
  slick:'friend', hoss:'friend', bub:'friend', kid:'friend',
  /* agreement and enthusiasm */
  fr:'yes', frfr:'yes', deadass:'yes', straight:'yes', truth:'yes',
  tru:'yes', true:'yes', valid:'yes', solid:'yes', saylessss:'yes',
  sayless:'yes', indeed:'yes', certainly:'yes', sure:'yes', yesh:'yes',
  yuh:'yes', yuhh:'yes', mmhm:'yes', mhm:'yes', uhhuh:'yes',
  /* disagreement */
  nocap:'honestly', nop:'no', nuh:'no', nuhuh:'no', negatory:'no',
  /* quality words that used to fall through */
  fire:'great', bussin:'great', slaps:'great', goated:'great',
  elite:'great', clean:'great', tight:'great', dope:'great',
  banger:'great', legit:'great', primo:'great',
  mid:'not great', trash:'bad', rubbish:'bad', booty:'bad',
  whack:'bad', wack:'bad', ass:'bad', rough2:'bad',
  /* state of business */
  poppin:'busy', bumpin:'busy', jammed:'busy', stacked:'busy',
  cooked:'busy', drowning:'busy', maxed:'busy',
  dry:'slow', dead:'slow', crickets:'slow', quiet:'slow',
  sluggish:'slow', stale:'slow', flat:'slow',
  /* money and work */
  bread:'money', bag:'money', racks:'money', coin:'money',
  cheddar:'money', paper:'money', revenue:'revenue', rev:'revenue',
  gig:'job', gigs:'jobs', ticket:'ticket', tix:'ticket',
  /* marketing shorthand people actually use */
  aeo2:'ai search', geo2:'ai search', sgeo:'ai search',
  serp:'search results', serps:'search results', backlink:'links',
  backlinks:'links', kw:'keywords', kws:'keywords',
  ctr:'click through rate', cpm:'cost per thousand',
  utm:'tracking', ga4:'analytics', gsc:'search console',
  cms:'website', wp:'wordpress', wix:'website builder',
  squarespace:'website builder', godaddy:'website builder'
};
...
KB.push(
{id:'greet', w:1.2, k:'hi,hello,hey,hey there,hi there,good day,greetings,anyone there,anybody there,is anyone there,knock knock,hello there,hey man,hi friend,hey friend,hello friend,hey dog,what up dog,yo dog,hey buddy,hey boss,hey chief,hi there friend,howdy partner,hey you,good to see you,nice to meet you,hey bot,hello bot',
...
{id:'whatsup', w:1.4, k:'what is up,what up,what is good,what is happening,what is new,what is going on,what is crackin,what is poppin,what it do,how is it going,how is everything,how goes it,how is life,how is business,how are you,how are things,how you doing,how is your day,how is your day going,how has your day been,what are you doing,what are you up to,you good,how have you been,long time,how is it hanging,how is work,how is it going friend,how are you friend,how is your day friend,what is going on friend,what is up friend,how is business treating you,how is the year going,how is the season,busy season treating you,you having a good day,everything good,all good,doing alright,you alright',
...
{id:'yes', w:1.1, k:'yes,sure,ok,okay,sounds good,go ahead,do it,please do,say less,lets hear it,hit me,shoot,i guess,why not,absolutely,definitely,for sure,right on,lets go,lets do it,alright then,fire away',
...
/* ─────────────────────────── WHY ANY OF THIS MATTERS ───────────────────
   Persuasion by arithmetic, not by pressure. Every one of these ends with
   a question rather than a pitch, because the homeowner logic works on
   contractors too: nobody argues with a number they worked out themselves.
   ───────────────────────────────────────────────────────────────────── */
KB.push(
{id:'whyadvertise', w:2.4, k:'why advertise,why should i advertise,do i need marketing,do i need advertising,is marketing worth it,why do i need this,do i really need,whats the point,why bother,i do fine without it,never needed it,my work speaks for itself',
 r:['Fair question, and I am not going to answer it with a slogan.\n\nHere is the only argument that matters. Right now, somebody within ten miles of you has the exact problem you fix, and in the next hour they are going to pick somebody. Not the best contractor in your county. The one they can find and the one who answers. Those are two different lists, and craftsmanship does not put you on either.\n\nBeing the best in town only pays if the town can find you. Invisible and excellent pays exactly the same as invisible.\n\nSo the real question is not whether marketing is worth it. It is how many of those decisions this month happened without your name in the room. Want to find out what that number looks like for your trade?'],
 qr:['Run my numbers','Free audit','How many leads am I missing?']},

{id:'whyoptimize', w:2.4, k:'why optimize my website,why does my website matter,is my website important,do i need a good website,website matter,why seo,why does seo matter,is seo worth it,whats seo for,why not just ads',
 r:['Because every other dollar you spend eventually lands there.\n\nYard sign, truck wrap, referral from a neighbor, Facebook ad, Google ad — almost all of it ends with somebody typing your name or your trade into a phone and looking at a page for about four seconds. That page decides whether the last dollar you spent turns into a call or turns into nothing.\n\n' + STAT.leak + '\n\nThat is why we fix conversion before we buy traffic. Sending more people to a page that leaks is just paying to lose faster. What does your site do when somebody lands on it at 9pm with a busted water heater — can they call you in one tap?'],
 qr:['Website scorecard','Conversion rate','Free audit']},

{id:'aifuture', w:2.5, k:'ai citations,why ai matters,do i need ai,is ai important,ai future,next decade,future of search,will people still use google,is seo dead,does seo still work,ai is going to kill,should i worry about ai',
 r:['This is the part I would pay attention to if I were you, and most of your competition is not.\n\nThe first page of Google is no longer the first thing a homeowner sees. They ask an assistant, it names two or three companies, and that shortlist is the whole decision. Getting named is its own job now, and the field is wide open — 2026 research suggests only about 1.2 percent of local businesses surface in AI recommendations at all.\n\nThe traffic that does come through converts hard, because the person already did their comparing inside the chat before they ever clicked. Independent 2026 measurements put AI-referred visitors converting several times better than ordinary search traffic.\n\nThe good news is it is not a separate budget. Complete profile, consistent business information, steady real reviews, clean structured data, real proof of work in real places. Boring fundamentals, done well enough that a machine can read them and trust them.\n\nContractors who sort that out this year are going to look lucky in three. What does your Google profile look like right now?'],
 qr:['Google Business Profile','Local SEO','Free audit']},

{id:'missing', w:2.3, k:'how many leads am i missing,how much am i losing,what am i leaving on the table,am i losing money,whats it costing me,cost of doing nothing',
 r:['We can actually work that out instead of guessing, and it takes about a minute.\n\nRough shape of it: your market has a search volume, you are getting some share of it, and the gap between those two is the number. Most contractors are surprised by the gap in the wrong direction.\n\nBut the version that hits hardest is simpler. Take your average job, multiply by three, multiply by fifty weeks. That is what three extra jobs a week is worth to you in a year. Most owners go quiet when they see it.\n\nGive me your average job value and I will run the whole thing — profit per job, your break-even cost per lead, and what that gap is costing. You keep the answer whether you ever call us or not.'],
 qr:['Run my numbers','Free audit','What would it cost?']},

{id:'notyet', w:2.2, k:'maybe next year,not right now,after the season,when things slow down,when i have money,when im bigger,too early for me,not the right time',
 r:['Understood, and I am not going to push you. One thing worth knowing before you file it away, though.\n\nSearch compounds. The work you start in your busy season is what carries your slow one, because organic takes four to eight months to mature. Waiting until the phone goes quiet means starting the clock at the exact moment you needed it finished.\n\nThat is not a reason to spend money you do not have. It is a reason to at least know where you stand, which is free. The audit costs nothing and you keep it either way — even if the answer is come back in March.'],
 qr:['Free audit','Free tools','Have someone call me']});
...
var ALIAS = {
  ...
  'tell me a joke'        : 'joke',
  'how many leads am i missing?' : 'missing',
  'how many leads am i missing'  : 'missing',
  'why advertise'         : 'whyadvertise',
  'why does my website matter' : 'whyoptimize',
  'ai citations'          : 'aifuture'
};
...
/* ==========================================================================
   ...
   ========================================================================== */
var FULL = '<svg class="afcb-man" viewBox="50 -185 370 680" aria-hidden="true" focusable="false">'
+'<defs>'
...
/* ── the speech bubble ─────────────────────────────────────────────────── */
+'.afcb-say{position:absolute;bottom:56vh;left:0;width:390px;max-width:86vw;opacity:0;'
 +'transform:translateX(var(--sayx)) translate(var(--saysh),10px) scale(.7);transform-origin:50% 110%;'
 +'pointer-events:none}'
+'.afcb-say b{display:block;background:#fff;color:#12161C;border:6px solid #0D1117;border-radius:26px;'
 +'padding:24px 28px 26px;font:400 16px/1.62 Inter,system-ui,-apple-system,sans-serif;'
...
+'.afcb-say s{position:absolute;left:50%;bottom:-34px;margin-left:-25px;width:50px;height:46px;z-index:1;'
...
/* ── the man on stage ──────────────────────────────────────────────────── */
+'.afcb-hero{position:absolute;bottom:5vh;left:0;width:15vw;min-width:120px;max-width:204px;'
...
+'@media(max-width:640px){.afcb-truck{width:92vw;min-width:0}.afcb-hero{width:27vw;min-width:106px}'
 +'.afcb-portal{width:44vw}.afcb-puddle{width:44vw}'
 +'.afcb-say{width:88vw;bottom:40vh}.afcb-say b{padding:20px 20px 22px;font-size:15px;line-height:1.58}'
...
+ '<s><svg viewBox="0 -10 50 50" aria-hidden="true"><path d="M4 -8 C 6 16 16 28 25 42'
+ ' C 28 28 40 12 46 -8 Z" fill="#fff" stroke="#0D1117" stroke-width="6" stroke-linejoin="round"'
+ ' stroke-linecap="round"/></svg></s>';
...
+'.afcb-btn::-moz-focus-inner{border:0;padding:0}'
+'.afcb-dismiss{-webkit-tap-highlight-color:transparent}'
+'.afcb-btn:after{content:"";position:absolute;left:47%;bottom:2px;width:74px;height:13px;margin-left:-37px;'
...
function build(){
  ...
  if (cine && !(CFG.arriveOnce && flag('afcRivitArrived') === '1') && flag('afcRivitClosed') !== '1'){
    ...
    dismissBtn.style.opacity = '0'; dismissBtn.style.pointerEvents = 'none';
    cine.arrive(function(){
      ...
      dismissBtn.style.transition = 'opacity .4s'; dismissBtn.style.opacity = '';
  ...
  W.afcBot = {
    ...
    replay: function(){
      ...
      cine.arrive(function(){
        ...
        dismissBtn.style.opacity = ''; dismissBtn.style.pointerEvents = '';
        animating = false;
      });
    },
